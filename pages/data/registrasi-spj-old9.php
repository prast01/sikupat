									...
									<div class="form-group">
										...
										<select name="kd_kegiatan" id="kd_kegiatan" class="form-control" required="" onchange="getSpj(this)">
											...
											<?php
												...
												$quer2=mysql_query("SELECT * from kegiatan WHERE (kseksi='$kseksi' OR id_kegiatan IN (SELECT id_kegiatan FROM spj WHERE kbidang2='DK007' AND kseksi='$kseksi' GROUP BY id_kegiatan) OR id_kegiatan IN (SELECT id_keg FROM target_detail WHERE seksi='DJ002' AND seksi_pl='$kseksi' AND bulan='$b')) AND kirim='0'");
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<select name="kd_kegiatan" id="kd_kegiatan" class="form-control" required="" onchange="getSpj(this)">
											...
											<?php
												if($kseksi == 'DJ001'){
													$quer2=mysql_query("SELECT * from kegiatan WHERE (kseksi='$s[kseksi]' OR id_kegiatan IN (SELECT id_kegiatan FROM spj WHERE kbidang2='DK007' AND kseksi='$s[kseksi]' GROUP BY id_kegiatan) OR id_kegiatan IN (SELECT id_keg FROM target_detail WHERE seksi='DJ002' AND seksi_pl='$s[kseksi]' AND bulan='$b')) AND kirim='0'");
												} else {
													$quer2=mysql_query("SELECT * from kegiatan WHERE (kseksi='$kseksi' OR id_kegiatan IN (SELECT id_kegiatan FROM spj WHERE kbidang2='DK007' AND kseksi='$kseksi' GROUP BY id_kegiatan) OR id_kegiatan IN (SELECT id_keg FROM target_detail WHERE seksi='DJ002' AND seksi_pl='$kseksi' AND bulan='$b')) AND kirim='0'");
												}
												while($row=mysql_fetch_assoc($quer2)){
