										...
										<tbody>
											...
											if ($_POST['ckseksi'] != '' && $_POST['ckkegiatan'] != '') {
												...
												while ($h = mysql_fetch_assoc($q)) {
													...
													$s = mysql_fetch_assoc(mysql_query("SELECT SUM(nominal) as nominal FROM target_detail WHERE id_spj='$h[id_spj]' AND seksi_pl='$id_seksi'"));
													$sisa = $h['pagu_anggaran'] - $s['nominal'];
											?>
													<tr>
														<td style="text-align:center"><?php echo $no; ?></td>
														<td style="text-align:left">
															<?php echo $h['kode_rekening'] . "<br><b>Pagu</b><br><b>" . number_format($h['pagu_anggaran'], 0, ',', '.') . "</b>"; ?>
															<?php
														...
														<td>
															...
															?>
																<b>Gagal Bayar :</b> <br>
																<b><?php echo number_format($sisa2, 0, ',', '.'); ?></b>
															<?php
															}
															?>
														</td>
														...
														?>
															<td style="text-align:center">
																...
																?>
																<input type="number" onclick="editTarget('target','<?php echo $h['id_spj']; ?>', '<?php echo $i; ?>', '<?php echo $h['uraian_kegiatan']; ?>', 'target', '<?php echo $kseksi2; ?>', '<?php echo $id_seksi; ?>', '<?php echo $id_keg; ?>', '<?php echo $id_seksi; ?>', '<?php echo $id_keg; ?>')" readonly value="<?php echo $nominal; ?>" name="Input" id="Input" onchange="update_target(this, '<?php echo $h['id_spj']; ?>', '<?php echo $i; ?>', '<?php echo $id_keg; ?>')" style="width:110px; <?php if ($i == date('m')) {
											...
											if (isset($_POST['lihat'])) {
												$id_keg = $_POST['ckkegiatan'];
												$q = mysql_fetch_assoc(mysql_query("SELECT * FROM tb_tw WHERE id_kegiatan='$id_keg'"));
											?>
												<tr>
													<td colspan="4" align="right">Tri Wulan (Rp)</td>
													<td colspan="3" align="center"><b><?php echo number_format($q['tw1'], 0, ',', '.'); ?></b></td>
													<td colspan="3" align="center"><b><?php echo number_format($q['tw2'], 0, ',', '.'); ?></b></td>
													<td colspan="3" align="center"><b><?php echo number_format($q['tw3'], 0, ',', '.'); ?></b></td>
													<td colspan="3" align="center"><b><?php echo number_format($q['tw4'], 0, ',', '.'); ?></b></td>
												</tr>
												...
												<b><?php echo number_format($sisa, 0, ',', '.'); ?></b> -->
														...
														?>
															<td style="text-align:center">
																...
																?>
																<input type="number" onclick="editTarget('target','<?php echo $h['id_spj']; ?>', '<?php echo $i; ?>', '<?php echo $h['uraian_kegiatan']; ?>', 'target', 'DJ002', 'DJ002', '6', '<?php echo $id_seksi; ?>')" readonly value="<?php echo $nominal; ?>" name="" id="<?php echo $h['id_spj'] . $i; ?>" style="width:110px; <?php if ($i == date('m')) {
																																																																																															echo "border:1px solid red";
																																																																																														} ?>">
