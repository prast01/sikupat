...
<div class="tab-content">			
	<div class="panel-body" >	
		<div class="panel panel-default" style="">
			...
			<div class="panel-body">
				<?php
					if(($act=="tampil" || isset($_POST['bulan'])) && ($kseksi == 'DJ001' || date("Y-m-d") < '2019-11-28')){
				?>
					...
					<?php
						if(isset($_POST['simpan'])){
							...
							if($hari_ini > $batas){
								echo "<script>alert('Data Gagal Disimpan. Tanggal Kegiatan SPJ Melewati batas 5 Hari Kerja.');</script>";
							} else {
								$ok = 0;
								$jenis = $_POST['jenis_spj'];
								if ($jenis != "") {
									if ($jenis == '0') {
										if ($tgl_kegiatan <= '2019-12-23') {
											$ok = 1;
										} else {
											echo "<script>alert('Data Gagal Disimpan. Tanggal Kegiatan SPJ Melewati batas tanggal kegiatan 23 Desember 2019. Jika Kegiatan melebihi tanggal 23 Desember 2019, silahkan konsultasikan ke Subbag Renval dan Keuangan.');</script>";
										}
