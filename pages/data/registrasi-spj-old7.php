	...
	if ($q['kode_rekening'] == '511.08.001' || $q['kode_rekening'] == '511.08.002' || $q['kode_rekening'] == '511.08.003' || $q['kode_rekening'] == '511.09.001') {
		...
		if(in_array($file_ext, $allowed_ext) === true){
			if($file_size < 10000000){
				...
				if ($a) {
					$hsl = array("res"=>1, "msg"=>$name);
				} else {
					$hsl = array("res"=>0, "msg"=> "Gagal Upload File-2".$lokasi);
				}
			} else {
				// echo "<script>alert('Gagal Upload File'); window.location='?cat=data&page=registrasi-spj&act=tampil'</script>";
				$hsl = array("res"=>0, "msg"=> "Gagal Upload File");
			}
		}else {
			// echo "<script>alert('Ekstensi file tidak diijinkan'); window.location='?cat=data&page=registrasi-spj&act=tampil'</script>";
...
function _delFoto($foto)
{
	$hasil = 0;
	$lokasi = 'pages/data/file_kegiatan/'.$foto;
	$hapus = unlink($lokasi);
	if ($hapus) {
		$hasil = 1;
	} else {
				...
				<?php
						if(isset($_POST['tolak'])){
							...
							if($_POST['act'] == 'tolak'){
								...
								$hasil = mysql_query("UPDATE bibs SET tolak='0', alasan='$alasan', terima='1', tgl_terima='$tgl', merah='' WHERE  kd_transaksi='$kd_transaksi'");
							}
										...
										if ($kseksi == 'DJ001') {
											if($bulan != 'all'){
												if ($guls != 'all') {
													if ($sek != 'all') {
														if ($stat == '0') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.kseksi='$sek' AND a.terima='0' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif($stat == '1') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='1' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '2') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '3') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='0' AND a.validasi='1' order by a.id ASC");
														} else {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.kseksi='$sek' order by a.id ASC");
														}
														
													} else {
														if ($stat == '0') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.terima='0' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif($stat == '1') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.terima='1' AND a.tolak='1' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '2') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.terima='1' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '3') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.terima='1' AND a.tolak='0' AND a.validasi='1' order by a.id ASC");
														} else {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' order by a.id ASC");
														}
														// $query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' order by a.id ASC");
													}
												} else {
													if ($sek != 'all') {
														if ($stat == '0') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' AND a.terima='0' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif($stat == '1') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='1' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '2') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '3') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='0' AND a.validasi='1' order by a.id ASC");
														} else {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' order by a.id ASC");
														}
														// $query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' order by a.id ASC");
													} else {
														if ($stat == '0') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.terima='0' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif($stat == '1') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.terima='1' AND a.tolak='1' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '2') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.terima='1' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '3') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.terima='1' AND a.tolak='0' AND a.validasi='1' order by a.id ASC");
														} else {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' order by a.id ASC");
														}
														// $query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' order by a.id ASC");
													}
												}
												...
												if ($guls != 'all') {
													if ($sek != 'all') {
														if ($stat == '0') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.kseksi='$sek' AND a.terima='0' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif($stat == '1') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='1' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '2') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '3') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='0' AND a.validasi='1' order by a.id ASC");
														} else {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.kseksi='$sek' order by a.id ASC");
														}
														
													} else {
														if ($stat == '0') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.terima='0' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif($stat == '1') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.terima='1' AND a.tolak='1' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '2') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.terima='1' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '3') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' AND a.terima='1' AND a.tolak='0' AND a.validasi='1' order by a.id ASC");
														} else {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' order by a.id ASC");
														}
														// $query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.jenis = '$guls' order by a.id ASC");
													}
												} else {
													if ($sek != 'all') {
														if ($stat == '0') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' AND a.terima='0' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif($stat == '1') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='1' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '2') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '3') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' AND a.terima='1' AND a.tolak='0' AND a.validasi='1' order by a.id ASC");
														} else {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' order by a.id ASC");
														}
														// $query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.kseksi='$sek' order by a.id ASC");
													} else {
														if ($stat == '0') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.terima='0' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif($stat == '1') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.terima='1' AND a.tolak='1' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '2') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.terima='1' AND a.tolak='0' AND a.validasi='0' order by a.id ASC");
														} elseif ($stat == '3') {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' AND a.terima='1' AND a.tolak='0' AND a.validasi='1' order by a.id ASC");
														} else {
															$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' order by a.id ASC");
														}
														// $query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.tgl_transfer = '0000-00-00' AND a.kseksi != '' order by a.id ASC");
													}
												}
											...
											if($bulan != 'all'){
												$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND MONTH(a.tgl_kegiatan)='$bulan' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.kseksi='$kseksi' order by a.id ASC");
											} else {
												$query = mysql_query("SELECT a.id, a.kd_transaksi, a.tgl_kegiatan, a.tgl_transfer, a.nominal, c.kode_rekening, c.uraian_kegiatan, a.uraian, d.nm_kegiatan, a.kseksi, a.tolak, a.alasan, a.validasi, a.tgl_terima, a.terima, a.jenis, a.merah, a.berkas FROM bibs a, spj c, kegiatan d WHERE YEAR(a.tgl_kegiatan)='$tahun' AND a.id_spj=c.id_spj AND c.id_kegiatan=d.id_kegiatan AND a.kseksi='$kseksi' order by a.id ASC");
											}
										}
										$tt = 0;
									...
									<tr bgcolor="<?php echo $bg; ?>">	
										...
										<td valign="top" align="left" bgcolor="">
											<?php
												...
												if($hasil['berkas'] != ''){
											?>
											<br><br> <a href="pages\data\file_kegiatan\<?php echo $hasil['berkas']; ?>" target="_blank" rel="noopener noreferrer" class="btn btn-warning btn-sm">Lihat Foto</a>
											<?php
												}
											?>
										</td>
...
if(isset($_GET['del'])){
	...
	$file = 'pages/data/file_kegiatan/'.$a['berkas'];
	unlink($file);
