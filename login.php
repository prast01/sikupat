...
<ul>
<li>
    <input type="btn" value="UKBM" class="btn" onClick="window.location='index_ukbm.php'" style="text-align: center">
</li>
<hr>
<li>
<input type="btn" value="KLINIK" class="btn" onClick="window.location='index_klinik.php'" style="text-align: center">
</li>
<hr>
<li>
<input type="btn" value="SIE KETENAGAAN" class="btn" onClick="window.location='index_sie.php'" style="text-align: center">
</li>
</ul>
</form>
